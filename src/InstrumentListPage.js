                    ...
                    {instruments.map((instrument) => (
                        ...
                        <div key = {instrument.id + 4} className="card col-sm-3 d-inline-block m-1 p-2">
                            ...
                            <div className="card-body">
                                <img className="img-fluid" style={{maxHeight: 200}} alt="hello word, ide kéne a képed" src={instrument.imageURL ? instrument.imageURL : "https://via.placeholder.com/400x800"}/>
                            </div>
                            </NavLink>
                            <br/>
